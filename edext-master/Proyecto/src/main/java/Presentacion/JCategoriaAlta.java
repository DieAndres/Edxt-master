...
public class JCategoriaAlta extends BackGround{
	/**
	 * 
	 */
	 ...
	 * Create the panel.
	 */
	public JCategoriaAlta(IAlta iAlta,Principal principal) {
		...
		JLabel lblNewLabel_1 = new JLabel("Crear Categoria");
		...
		lblExiste = new JLabel("La categoria ya existe");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(txtNom.getText().equals("") == false) {
					...
					if(iAlta.registroCategoria(txtNom.getText())==false) {
