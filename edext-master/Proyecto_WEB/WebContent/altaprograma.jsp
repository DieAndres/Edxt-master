...
<!--------------------->
<div id="page">
	<form action="AltaPrograma" method="post">
	  <div class="form-group">
    	<label for="inputAddress">Nombre</label>
   		<input type="text" class="form-control" id="inputAddress" name="nomProg">
  	  </div>
	  <div class="form-group">
  	  ...
  	  <div class="row">
      <div class="col">
      	<label for="exampleFormControlFile1">Período de vigencia</label>
        <input type="text" class="form-control" placeholder="Fecha inicio" id=datepicker01 name="fIni">
      </div>
      <div class="col">
      	<label for="exampleFormControlFile1"></label>
        <input type="text" class="form-control" placeholder="Fecha fin" id=datepicker02 name="fFin">
      </div>
  	 </div>
  	 <div class="w-50 mt-3">
    ...
    <div>
	  <button type="submit" class="btn btn-primary mt-3" id="aceptar">Aceptar</button>
	</div>
