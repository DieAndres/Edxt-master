...
public class DtDocente  extends Publicaciones.DtUsuario  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://Publicaciones/", "dtDocente"));
